...
export const FLAG_DIRTY_CLEARED_CACHE = 0b0000001
export const FLAG_DIRTY_NEW_PAGE = 0b0000010
export const FLAG_DIRTY_PAGE_DATA_CHANGED = 0b0000100
export const FLAG_DIRTY_STATIC_QUERY_FIRST_RUN = 0b0001000
export const FLAG_DIRTY_STATIC_QUERY_RESULT_CHANGED = 0b0010000
export const FLAG_DIRTY_BROWSER_COMPILATION_HASH = 0b0100000
export const FLAG_DIRTY_SSR_COMPILATION_HASH = 0b1000000
